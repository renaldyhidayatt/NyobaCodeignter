  ...
  <div id="wrapper">
    <div id="receiptData" style="width: auto; max-width: 580px; min-width: 250px; margin: 0 auto;">
      <div id="receipt-data">
            ...
            <p style="text-align:center;"><strong>Payment Made</strong>                               
            <p>
              Date hour:  <?php echo $quotasPaid[0]->pay_date; $total = 0; ?><br>
              Loan No.: <?php echo $loan_id; ?> <br>
              Client: <?php echo $name_cst; ?> <br>
              Currency type: <?php echo $coin; ?><br>
            </p>
            ...
            <table class="table table-condensed">
              <thead>
                <tr>
                  ...
                  <th class="text-center" style="width: 24%; border-bottom: 2px solid #ddd;">Amount Canceled</th>
