<div class="card shadow mb-4">
  <div class="card-header d-flex align-items-center justify-content-between py-3">
    <h6 class="m-0 font-weight-bold text-primary">Loan report by date range</h6>
  </div>
  <div class="card-body">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-3">
        ...
        <label class="small mb-1" for="exampleFormControlSelect2">Start date</label>
        <input type="date" id="start_d" class="form-control">
      </div>

      <div class="form-group col-md-3">

        <label class="small mb-1" for="exampleFormControlSelect2">Final date</label>
        <input type="date" id="end_d" class="form-control">
      </div>

      <div class="form-group col-md-3">
        <label class="small mb-1" for="exampleFormControlSelect2">Type of currency</label>
