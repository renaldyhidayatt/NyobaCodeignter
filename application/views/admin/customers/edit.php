<div class="card shadow mb-4">
  <div class="card-header py-3"><?php echo empty($customer->first_name) ? 'New Customer' : 'Edit Customer'; ?></div>
  <div class="card-body">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            <label class="small mb-1" for="exampleFormControlTextarea1">Enter Nicknames</label>
        ...
        <div class="form-group col-md-3">
            <label class="small mb-1" for="exampleFormControlSelect2">Select genre</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-4">
        <label class="small mb-1" for="exampleFormControlSelect2">Select Department</label>
      ...
      <div class="form-group col-md-4">
        <label class="small mb-1" for="exampleFormControlSelect2">Select province</label>
      ...
      <div class="form-group col-md-4">
        <label class="small mb-1" for="exampleFormControlSelect2">select district</label>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            <label class="small mb-1" for="inputUsername">Enter address</label>
        ...
        <div class="form-group col-md-4">
            <label class="small mb-1" for="exampleFormControlTextarea1">Enter Cell</label>
        ...
        <div class="form-group col-md-4">
            <label class="small mb-1" for="exampleFormControlTextarea1">Enter Phone</label>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            <label class="small mb-1" for="inputUsername">Enter social reason</label>
        ...
        <div class="form-group col-md-4">
            <label class="small mb-1" for="inputUsername">Input ruc</label>
        ...
        <div class="form-group col-md-4">
            <label class="small mb-1" for="inputUsername">Enter company</label>
