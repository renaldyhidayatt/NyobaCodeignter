<div class="card shadow mb-4">
  <div class="card-header py-3"><?php echo empty($coin->name) ? 'New currency' : 'Edit currency'; ?> </div>
  <div class="card-body">
    <?php if(validation_errors()) { ?>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label class="small mb-1" for="inputUsername">enter currency</label>
        ...
        <div class="form-group col-md-6">
          <label class="small mb-1" for="inputUsername">enter abbreviation</label>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <label class="small mb-1" for="inputUsername">enter symbol</label>
        ...
        <div class="form-group col-md-6">
          <label class="small mb-1" for="exampleFormControlTextarea1">enter description</label>
      ...
      <button class="btn btn-primary" type="submit">register currency</button>
      <a href="<?php echo site_url('admin/coins/'); ?>" class="btn btn-dark">Cancel</a>
